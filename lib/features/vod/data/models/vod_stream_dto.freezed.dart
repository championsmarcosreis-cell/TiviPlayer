...
mixin _$VodStreamDto {
 ...
 String get streamId; String get name; String? get categoryId; String? get streamIcon; String? get containerExtension; String? get rating;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,streamId,name,categoryId,streamIcon,containerExtension,rating);

@override
String toString() {
  return 'VodStreamDto(streamId: $streamId, name: $name, categoryId: $categoryId, streamIcon: $streamIcon, containerExtension: $containerExtension, rating: $rating)';
}
...
@useResult
$Res call({
 String streamId, String name, String? categoryId, String? streamIcon, String? containerExtension, String? rating
});
...
/// Create a copy of VodStreamDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? streamId = null,Object? name = null,Object? categoryId = freezed,Object? streamIcon = freezed,Object? containerExtension = freezed,Object? rating = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String streamId,  String name,  String? categoryId,  String? streamIcon,  String? containerExtension,  String? rating)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VodStreamDto() when $default != null:
return $default(_that.streamId,_that.name,_that.categoryId,_that.streamIcon,_that.containerExtension,_that.rating);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String streamId,  String name,  String? categoryId,  String? streamIcon,  String? containerExtension,  String? rating)  $default,) {final _that = this;
switch (_that) {
case _VodStreamDto():
return $default(_that.streamId,_that.name,_that.categoryId,_that.streamIcon,_that.containerExtension,_that.rating);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String streamId,  String name,  String? categoryId,  String? streamIcon,  String? containerExtension,  String? rating)?  $default,) {final _that = this;
switch (_that) {
case _VodStreamDto() when $default != null:
return $default(_that.streamId,_that.name,_that.categoryId,_that.streamIcon,_that.containerExtension,_that.rating);case _:
  return null;
...
class _VodStreamDto implements VodStreamDto {
  const _VodStreamDto({required this.streamId, required this.name, this.categoryId, this.streamIcon, this.containerExtension, this.rating});
...
/// Create a copy of VodStreamDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? streamId = null,Object? name = null,Object? categoryId = freezed,Object? streamIcon = freezed,Object? containerExtension = freezed,Object? rating = freezed,}) {
