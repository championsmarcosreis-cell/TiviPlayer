...
mixin _$VodInfoDto {
 ...
 String get streamId; String get name; String? get plot; String? get genre; String? get cast; String? get director; String? get duration; String? get releaseDate; String? get coverBig; String? get backdropUrl; String? get rating; String? get containerExtension;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,streamId,name,plot,genre,cast,director,duration,releaseDate,coverBig,backdropUrl,rating,containerExtension);

@override
String toString() {
  return 'VodInfoDto(streamId: $streamId, name: $name, plot: $plot, genre: $genre, cast: $cast, director: $director, duration: $duration, releaseDate: $releaseDate, coverBig: $coverBig, backdropUrl: $backdropUrl, rating: $rating, containerExtension: $containerExtension)';
}
...
@useResult
$Res call({
 String streamId, String name, String? plot, String? genre, String? cast, String? director, String? duration, String? releaseDate, String? coverBig, String? backdropUrl, String? rating, String? containerExtension
});
...
/// Create a copy of VodInfoDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? streamId = null,Object? name = null,Object? plot = freezed,Object? genre = freezed,Object? cast = freezed,Object? director = freezed,Object? duration = freezed,Object? releaseDate = freezed,Object? coverBig = freezed,Object? backdropUrl = freezed,Object? rating = freezed,Object? containerExtension = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String streamId,  String name,  String? plot,  String? genre,  String? cast,  String? director,  String? duration,  String? releaseDate,  String? coverBig,  String? backdropUrl,  String? rating,  String? containerExtension)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _VodInfoDto() when $default != null:
return $default(_that.streamId,_that.name,_that.plot,_that.genre,_that.cast,_that.director,_that.duration,_that.releaseDate,_that.coverBig,_that.backdropUrl,_that.rating,_that.containerExtension);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String streamId,  String name,  String? plot,  String? genre,  String? cast,  String? director,  String? duration,  String? releaseDate,  String? coverBig,  String? backdropUrl,  String? rating,  String? containerExtension)  $default,) {final _that = this;
switch (_that) {
case _VodInfoDto():
return $default(_that.streamId,_that.name,_that.plot,_that.genre,_that.cast,_that.director,_that.duration,_that.releaseDate,_that.coverBig,_that.backdropUrl,_that.rating,_that.containerExtension);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String streamId,  String name,  String? plot,  String? genre,  String? cast,  String? director,  String? duration,  String? releaseDate,  String? coverBig,  String? backdropUrl,  String? rating,  String? containerExtension)?  $default,) {final _that = this;
switch (_that) {
case _VodInfoDto() when $default != null:
return $default(_that.streamId,_that.name,_that.plot,_that.genre,_that.cast,_that.director,_that.duration,_that.releaseDate,_that.coverBig,_that.backdropUrl,_that.rating,_that.containerExtension);case _:
  return null;
...
class _VodInfoDto implements VodInfoDto {
  const _VodInfoDto({required this.streamId, required this.name, this.plot, this.genre, this.cast, this.director, this.duration, this.releaseDate, this.coverBig, this.backdropUrl, this.rating, this.containerExtension});
...
/// Create a copy of VodInfoDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? streamId = null,Object? name = null,Object? plot = freezed,Object? genre = freezed,Object? cast = freezed,Object? director = freezed,Object? duration = freezed,Object? releaseDate = freezed,Object? coverBig = freezed,Object? backdropUrl = freezed,Object? rating = freezed,Object? containerExtension = freezed,}) {
