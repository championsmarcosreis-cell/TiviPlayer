...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SeriesCategoryDto&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.categoryName, categoryName) || other.categoryName == categoryName)&&(identical(other.parentId, parentId) || other.parentId == parentId)&&(identical(other.libraryKind, libraryKind) || other.libraryKind == libraryKind));
}
...
@override
String toString() {
  return 'SeriesCategoryDto(categoryId: $categoryId, categoryName: $categoryName, parentId: $parentId, libraryKind: $libraryKind)';
}
...
class _SeriesCategoryDto implements SeriesCategoryDto {
  const _SeriesCategoryDto({required this.categoryId, required this.categoryName, this.parentId, this.libraryKind});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SeriesCategoryDto&&(identical(other.categoryId, categoryId) || other.categoryId == categoryId)&&(identical(other.categoryName, categoryName) || other.categoryName == categoryName)&&(identical(other.parentId, parentId) || other.parentId == parentId)&&(identical(other.libraryKind, libraryKind) || other.libraryKind == libraryKind));
}
