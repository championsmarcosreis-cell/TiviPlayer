 ...
 */
public abstract class VideoPlayer implements ManagedVideoPlayer {
  private static final String TAG = "TiviVideoPlayer";
  ...
  private static void setAudioAttributes(ExoPlayer exoPlayer, boolean isMixMode) {
    AudioAttributes audioAttributes =
        XiaomiDeviceQuirks.shouldApply()
            ? XiaomiDeviceQuirks.createAudioAttributes()
            : new AudioAttributes.Builder()
                .setUsage(C.USAGE_MEDIA)
                .setContentType(C.AUDIO_CONTENT_TYPE_MOVIE)
                .build();
    if (XiaomiDeviceQuirks.shouldApply()) {
      Log.i(TAG, "Applying Xiaomi audio attributes profile.");
    }
    exoPlayer.setAudioAttributes(audioAttributes, !isMixMode);
  }
