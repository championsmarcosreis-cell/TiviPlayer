...
import io.flutter.plugins.videoplayer.ManagedVideoPlayer;
...
public class PlatformVideoViewFactory extends PlatformViewFactory {
  ...
  public interface VideoPlayerProvider {
     ...
     */
    @NonNull
    ManagedVideoPlayer getVideoPlayer(@NonNull Long playerId);
  }
  ...
  public PlatformView create(@NonNull Context context, int id, @Nullable Object args) {
    ...
    final ManagedVideoPlayer player = videoPlayerProvider.getVideoPlayer(playerId);
    final ExoPlayer exoPlayer = player.getExoPlayer();
    if (exoPlayer == null) {
      throw new IllegalStateException("PlatformView playback requires an ExoPlayer-backed player.");
    }
