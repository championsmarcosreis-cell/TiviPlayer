...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  private final LongSparseArray<ManagedVideoPlayer> videoPlayers = new LongSparseArray<>();
  ...
  private void registerPlayerInstance(ManagedVideoPlayer player, long id) {
  ...
  @NonNull
  private ManagedVideoPlayer getPlayer(long playerId) {
    ManagedVideoPlayer player = videoPlayers.get(playerId);
  ...
  public void dispose(long playerId) {
    ManagedVideoPlayer player = getPlayer(playerId);
    player.dispose();
